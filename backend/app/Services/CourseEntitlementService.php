...
/** Shared course rights for playback, chat, projects and certificates. */
final class CourseEntitlementService
{
    ...
    private function resolveEntitlements(int $userId, Collection|array $courseIds): array
    {
        ...
        $holds = $enrollments->isNotEmpty() && FinancialProvenanceSchema::available()
    ...
    public function enrollmentHasCertificateAccess(CourseEnrollment $enrollment): bool
    {
        ...
        return !$this->holds->enrollmentHasActiveHold($enrollment, ['course'])
    ...
    public function activeEnrollmentFor(int $userId, int $courseId): ?CourseEnrollment
    {
        ...
        return $enrollment && !$this->holds->enrollmentHasActiveHold($enrollment, ['course'])
            ? $enrollment
            : null;
    }
    ...
    public function enrollmentAllowsVariableCostFeatures(CourseEnrollment $enrollment): bool
    {
        ...
        return $enrollment->isActive()
            ...
            && !$this->holds->enrollmentHasActiveHold($enrollment, ['course', 'chat', 'plan'])
