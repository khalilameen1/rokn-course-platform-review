...
return new class extends Migration
{
    ...
    {
        // Snapshots are immutable financial receipts. Once v6 rows exist,
    ...
    private function snapshotJsonSchema(): string
    {
        ...
        return (string) json_encode([
            ...
            'properties' => [
                'version' => ['type' => 'integer', 'enum' => [1, 2, 3, 4, 5, 6]],
            ...
            'oneOf' => [
                ...
                [
                    'required' => [...$v5Required, 'projects_enabled'],
                    'properties' => array_merge(
                        ['version' => ['type' => 'integer', 'enum' => [6]]],
                        $chatAttachmentProperties,
                        [
                            'projects_enabled' => ['type' => 'boolean'],
                            'project_followup_attachments_enabled' => ['type' => 'boolean'],
                            'project_followup_attachment_max_files' => [
                    ...
                    'anyOf' => [
                        ['properties' => ['projects_enabled' => ['enum' => [true]]]],
                        ['properties' => [
                            'projects_enabled' => ['enum' => [false]],
                            'certificate_enabled' => ['enum' => [false]],
                            'project_feedback_level' => ['enum' => ['pass_only']],
                            'project_output_enabled' => ['enum' => [false]],
                        ]],
                    ],
                ],
            ],
