...
@section('page.title', 'سياسة الخصوصية  ')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                    <textarea name="privacy_ar" class="form-control legal-editor__textarea" placeholder="سياسة الخصوصية ..." maxlength="" tabindex="4">
                                        {{ $about->privacy_ar }}
                                    </textarea>
                            </div>
                        </div>
            ...
            <div class="card admin-card legal-editor__card">
                <div class="card-header">
                    <i class="fa fa-file-text-o"></i><strong class="card-title pr-2"> سياسة الخصوصية بالأنجليزية</strong>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <textarea name="privacy_en" class="form-control legal-editor__textarea" placeholder="سياسة الخصوصية ..." maxlength="" tabindex="4">
                                    {{ $about->privacy_en }}
                                </textarea>
                            </div>
                        </div>
