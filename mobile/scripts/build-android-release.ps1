...
function Test-ProductionApiUrl {
    ...
    if ($normalized -cne 'https://rokn.app/api/v1/' -or $parsed.Query -or $parsed.Fragment) {
        throw "Production builds must use the deployed API base 'https://rokn.app/api/v1/'."
    }
}
